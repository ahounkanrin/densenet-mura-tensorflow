...
BODY_PART = 'all'
RESTORE_FROM = '/home/anicet/tmp/snapshots/wrist_0/model.ckpt-17066'#'/scratch/hnkmah001/densenet/snapshots/wrist_1/model.ckpt-17066'
...
def main():
    ...
    for i in tqdm(range(number_of_validation_studies),  desc='Evaluation'):
        ...
        for j in range(num_img):
            img_contents = tf.read_file(valid_studies_path[i]+img_list[j])
            img = tf.image.decode_png(img_contents, channels=3)
            img = valid_transforms(img, args.bpart)
